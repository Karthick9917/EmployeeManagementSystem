...
public class EmployeeConstants {
    ...
    public static final String EMPLOYEE_MANAGEMENT_MENU = "<<< Main Menu >>>" +
            ...
            "\n6.exit " +
            "\nSelect your option : ";
    public static final String SELECT_OPTION_ERROR = " Invalid option..!!";
    public static final String INPUT_MISMATCH_EXCEPTION = "Invalid data. Please enter valid data.!";
    public static final String HOUSE_NUMBER = "Enter building number : ";
    public static final String STREET_NAME = "Enter street name : ";
    public static final String AREA_NAME = "Enter area name : ";
    public static final String CITY_NAME = "Enter city name : ";
    public static final String PINCODE = "Enter pincode number : ";
    public static final String NAME = "Enter employee name: ";
