...
public class ProjectDTO {
    ...
    public ProjectDTO (int id, String projectName, String domain, LocalDate projectDue, LocalDate projectStart, LocalDate projectEnd, List<EmployeeDTO> employeeDTO) {
        this.id = id;
